...
<link href="{{ URL::asset('css/estilos.css') }}" rel="stylesheet" type="text/css"/>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Editar inventariable: {{$traslado->descripcionbien}}</div>
    ...
    {{ csrf_field() }}
                ...
                <input type="text" name="descripcionbien" class="form-control" value="{{ old('descripcionbien', $traslado->descripcionbien) }}">
...
<input type="text" name="ordendecompra" class="form-control" value="{{ old('ordendecompra', $traslado->ordendecompra) }}">
</td>
<td style="padding:0 0px 0 15px;">
<input type="number" min="1" max="999999" name="factura" class="form-control" value="{{ old('factura', $traslado->factura) }}">
</td>
<td style="padding:0 0px 0 15px;">
<input type="text" id="datepicker" name="fecha" class="form-control" value="{{ old('fecha', $traslado->fecha) }}">
</td>
<td style="padding:0 0px 0 15px;">
<input type="number" min="1" max="99999999" name="costo_incorporacion" class="form-control" value="{{ old('costo_incorporacion', $traslado->costo_incorporacion) }}">
<td>
